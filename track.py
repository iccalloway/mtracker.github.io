...
# get splines
with open(path_to_csv_output, "w") as csvfile:
	cnn_prediction.to_csv(csvfile, mode="a", header=True, line_terminator="\n")
	for index, img in enumerate(video):
		...
		##Write to csv line by line	-Ian
		temp_prediction = cnn_prediction.append(spline)
		temp_prediction.to_csv(csvfile, mode="a", header=False, line_terminator="\n")
